            ...
            wrap('Check if funds are available', async () => {
                ...
                if (isStatusMessage(irysData)) {
                    ...
                    if (irysData.uploadableMegabytes === 0) {
                        ...
                        setIrysDataMessage(errorMessage(`Critical low funding! Upload capacity to Arweave: ${irysData.uploadableMegabytes} MB`));
                    } else if (irysData.uploadableMegabytes < 10) {
                        setIrysDataMessage(warningMessage(`Low funding! Upload capacity to Arweave: ${irysData.uploadableMegabytes} MB`));
                    } else {
                        setIrysDataMessage(infoMessage(`Upload capacity to Arweave: ${irysData.uploadableMegabytes} MB`));
                    }
                }
    ...
    return (
        <Stack spacing={2}>
            ...
            <CollapsiblePanel
                ...
                collapsible={false}
                toolbar={[
                    <Button key={'clear-button'} disabled={!uploadFile}
                ...
                content={[
                    ...
                    >
                        ...
                        />
                        <FormControlLabel key={'new-key-pair'} value={'new-key-pair'} control={<Radio/>}
                                          label="New Key Pair"/>
                    </RadioGroup>,
