                ...
                <TableBody>
                    ...
                    <TableRowComp
                        ...
                        elements={[
                            ...
                            <AddressBoxWithCopy key={'address'} value={irysData.address} label={'Account'}
                                                reduced={true}/>
                        ]}
                        colspan={[1, 2]}
                    />
                    ...
                    <TableRowComp
                        ...
                        colspan={[1, 2]}
                    />
                    <TableRowComp key={'balances'} elements={[<Header2 key={'title'}>Balances</Header2>]}
                                  colspan={[3]}/>
                    <TableRowComp
                    ...
                    <TableRowComp
                        ...
                        elements={[
                            <Box key={'title'}
                                 sx={{fontWeight: 'bold'}}>{`Irys loaded balance (${irysAccess.getToken()})`}</Box>,
                    ...
                    <TableRowComp
                        ...
                        elements={[
                            <Box key={'title'}
                                 sx={{fontWeight: 'bold'}}>{`Irys balance (${irysAccess.getToken()})`}</Box>,
